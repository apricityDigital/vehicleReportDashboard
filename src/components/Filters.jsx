      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="border border-gray-300 rounded-md px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm w-40"
          />
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="border border-gray-300 rounded-md px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm w-36"
            placeholder="From"
          />
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="border border-gray-300 rounded-md px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm w-32"
          >
        ...
        {showTripCountFilter && (
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="border border-gray-300 rounded-md px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm w-28"
            >
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          {((dateRange?.from || dateRange?.to) || quickDate || selectedZone || (showTripCountFilter && tripCountFilter && tripCountFilter !== 'all')) && (
            <button
              ...
              className="bg-gray-100 hover:bg-red-100 text-gray-700 hover:text-red-600 font-medium py-2 px-4 rounded-md transition-colors flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
